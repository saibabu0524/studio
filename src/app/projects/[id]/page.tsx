...
export async function generateMetadata({ params }: ProjectDetailPageProps) {
  ...
  return {
    ...
    openGraph: {
        ...
        images: [
          {
            url: project.imageUrl, // Assuming imageUrl is an absolute URL
  ...
  return (
    <SectionWrapper className="py-12 md:py-16 lg:py-20 bg-background animate-fade-in-up">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <Card className="overflow-hidden shadow-xl border border-border/40">
          ...
          {(project.githubUrl || project.playStoreUrl) && (
            <CardFooter className="p-6 flex flex-col sm:flex-row justify-start gap-3 border-t border-border/40">
              {project.githubUrl && (
                <Button variant="outline" asChild className="w-full sm:w-auto shadow hover:shadow-md transition-shadow">
              ...
              {project.playStoreUrl && (
                <Button variant="default" asChild className="w-full sm:w-auto shadow hover:shadow-md transition-shadow">
